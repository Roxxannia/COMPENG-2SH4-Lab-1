...
//=========Question 1==================================
    ...
    void TestQ1_do(CuTest *tc) {
        ...
        //========= Additional test cases =========//
        actual = Q1_dowhile(18);
        expected = 27720;
        CuAssertIntEquals(tc, expected, actual);

        actual = Q1_dowhile(45);
        expected = 11385;
        CuAssertIntEquals(tc, expected, actual);
...
//=================Question 4================================ 
    ...
    void TestQ4_10(CuTest *tc) {
		...
		int targetArray[10] = {-1, 7, 23, -50, 100, 45, 300, -150, -190, 650};
		int inputSize = 10;
        int expectedArray[25] = {-190, -150, -50, -1, 7, 23, 45, 100, 300, 650};
        int expectedPass = 9;
        int actualPass = Q4_Bubble(targetArray, inputSize);        
        CuAssertIntEquals(tc, expectedPass, actualPass);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ3_neg2);
        SUITE_ADD_TEST(suite, TestQ3_pos2);
        SUITE_ADD_TEST(suite, TestQ3_pos3);
